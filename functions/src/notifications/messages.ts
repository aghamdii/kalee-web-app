...
export const NOTIFICATION_MESSAGES: Record<NotificationType, Record<Language, NotificationMessage>> = {
    trial_reminder: {
        ar: {
            title: '💚 تذكير سريع',
            body: 'تنتهي تجربتك المجانية غداً. نأمل أن كالي يساعدك في رحلتك الصحية. اشترك في أي وقت للاستمرار!'
        },
        en: {
            title: '💚 Quick reminder',
            body: 'Your trial ends tomorrow. We hope Kalee is helping your health journey. Subscribe anytime to continue!'
        },
        ja: {
            title: '💚 リマインダー',
            body: '無料トライアルは明日終了します。Kaleeがあなたの健康の旅に役立っていることを願っています。いつでも登録して続けましょう!'
        },
        ko: {
            title: '💚 간단한 알림',
            body: '무료 체험이 내일 종료됩니다. Kalee가 건강 여정에 도움이 되고 있기를 바랍니다. 언제든지 구독하여 계속하세요!'
        }
    }
};
